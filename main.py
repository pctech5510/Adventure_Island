...
''')
    print("You open the door and hear the angel's sing, you look to the left and see a beast diving at you! Game Over!")
elif choice_3 == "red":
    print(r'''
                               (
                .            )        )
    ...
    ''')
    print("You feel a  burst of hot air on your skin.. Game Over!")
